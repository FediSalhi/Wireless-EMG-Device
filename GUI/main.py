...
class serialPlot:
    def __init__(self, serialPort='COM7', serialBaud=38400, plotLength=100, dataNumBytes=2, numPlots=1):
        ...
        try:
            self.serialConnection = serial.Serial(serialPort, serialBaud, timeout=4)          #TODO: contorl this one fedi
